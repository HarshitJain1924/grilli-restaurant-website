pipeline {
    ...
    stages {
        ...
        // Optional: Stage to run the container locally for testing
        ...
        //         // Run the new container in detached mode (-d), map host port 8080 to container port 80 (-p 8080:80)
        //         sh "docker run -d --name grilli-app -p 8080:80 ${env.IMAGE_NAME}:latest"
        //         echo "Website should be available at http://<your-host-ip>:8080"
        //     }
        // }
    }
